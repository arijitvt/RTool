...
#   define CLAP_API 
  ...
  //int  CLAP_API clap_cond_timedwait(pthread_cond_t * cond, pthread_mutex_t * mutex, const struct timespec * abstime) { assert(0); }
  int  CLAP_API clap_cond_timedwait(pthread_cond_t * cond, pthread_mutex_t * mutex, const struct timespec * abstime) { return pthread_cond_timedwait(cond, mutex, abstime); }
...
//Daikon Interfacing code
#ifdef DAIKON
  int CLAP_API  getThreadId(pthread_t *threadStr) ;

#endif
  //int CLAP_API  getRunCount();
#ifdef __cplusplus
}
#endif
