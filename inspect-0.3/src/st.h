...
#define ST_CMP ST_PFICPCP
#define ST_PFI ST_PFICPI

EXTERN st_table *st_init_table_with_params ARGS((ST_PFICPCP, ST_PFICPI, int, int, double, int));
EXTERN st_table *st_init_table3 ARGS((ST_PFICPCP, ST_PFICPI));
#define st_init_table(c,h) st_init_table3((ST_PFICPCP)(c),(ST_PFICPI)(h))
#define st_init_table_with_size(c,h,n) st_init_table_with_params((ST_PFICPCP)(c),(ST_PFICPI)(h),n,ST_DEFAULT_MAX_DENSITY,ST_DEFAULT_GROW_FACTOR,ST_DEFAULT_REORDER_FLAG);
